...
float stdard[3] = { 0.229, 0.224, 0.225 };
...
void main() {
    ...
    int n_image = 32 * 32 * 3;
    readfile("image_no_transpose.txt", image, n_image);
 ...
 /*   float* input = (float*)malloc((32 * 32 * 3) * sizeof(float));
    ...
    int nb_6 = 256;
    readfile("W_6.txt", w_6, nw_6);
    //xuat(w_0, (3 * 3 * 3 * 64));
    readfile("bias_6.txt", bias_6, nb_6);
    ...
    int nb_7 = 512;
    readfile("W_7.txt", w_7, nw_7);
    //xuat(w_0, (3 * 3 * 3 * 64));
    readfile("bias_7.txt", bias_7, nb_7);
    ...
    int nb_8 = 512;
    readfile("W_8.txt", w_8, nw_8);
    //xuat(w_0, (3 * 3 * 3 * 64));
    readfile("bias_8.txt", bias_8, nb_8);
    ...
    int nb_9 = 512;
    readfile("W_9.txt", w_9, nw_9);
    //xuat(w_0, (3 * 3 * 3 * 64));
    readfile("bias_9.txt", bias_9, nb_9);
    ...
    int nb_11 = 512;
    readfile("W_11.txt", w_11, nw_11);
    //xuat(w_0, (3 * 3 * 3 * 64));
    readfile("bias_11.txt", bias_11, nb_11);
    ...
    int nb_12 = 512;
    readfile("W_12.txt", w_12, nw_12);
    //xuat(w_0, (3 * 3 * 3 * 64));
    readfile("bias_12.txt", bias_12, nb_12);
    ...
    readfile("dense_512.txt", w_512, nw_512);
    //xuat(w_128, nw_128);
    readfile("bias_dense_512.txt", bias_512, nb_512);
    ...
    readfile("dense_10.txt", w_dense_10, nw_dense_10);
    readfile("bias_dense_10.txt", bias_dense_10, nb_dense_10);
